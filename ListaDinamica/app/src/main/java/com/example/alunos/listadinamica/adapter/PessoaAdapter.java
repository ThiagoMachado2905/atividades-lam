...
public class PessoaAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertview, ViewGroup parent) {
        ...
        TextView textonome = v.findViewById(R.id.textonome);
        textonome.setText(obj.getNome());

        TextView textotelefone = v.findViewById(R.id.textotelefone);
        textotelefone.setText(obj.getTelefone());

        ImageView imagem = v.findViewById(R.id.imagem);
        imagem.setImageResource(obj.getImagem());
